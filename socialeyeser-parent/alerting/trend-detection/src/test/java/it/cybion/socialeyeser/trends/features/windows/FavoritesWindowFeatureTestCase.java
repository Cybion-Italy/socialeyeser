...
import it.cybion.socialeyeser.trends.features.sma.windows.FixedSizeFeatureWindow;
...
public class FavoritesWindowFeatureTestCase extends AbstractFeatureTestCase {
    ...
    public void shouldTestFixedTimeWindowFeature() throws Exception {
        ...
        feature = new FavoritesWindowFeature(new FixedTimeFeatureWindow(10000L));
    ...
    public void shouldTestFixedSizeWindowFeature() throws Exception {
        ...
        feature = new FavoritesWindowFeature(new FixedSizeFeatureWindow(10));
